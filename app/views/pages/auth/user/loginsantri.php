...
<section class="bg min-h-[100vh] flex flex-col items-center justify-center bg-gray-100">
  ...
  <div class="
    ...
    <div class="mt-10">
      <form action="/login-santri" method="post">
    ...
    <div class="flex justify-center items-center mt-6">
      <a href="#" target="_blank" class="
            ...
            text-xs text-center
          ">
        <span class="ml-2">Belum punya akun?
          <a href="/register-santri" data-route="/register-santri" class="text-xs ml-2 text-[#4CAF50] font-semibold">Daftar disini</a></span>
      </a>
    </div>
  </div>
</section>
