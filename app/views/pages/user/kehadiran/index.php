    ...
    <div class="container">
        <div class="content">
            <div class="flex justify-between">
                ...
                <a class="bg-[#4CAF50] rounded text-white px-3 py-2 hover:bg-green-500" href="/kehadiran/create">Tambah Kehadiran</a>
            </div>
            <table>
                <thead>
                    <tr>
                ...
                <tbody id="tableBody">
                    <?php foreach ($kehadiran as $key => $item) : ?>
                        <tr class="dataRow">
                            <td><?= $item->name; ?></td>
                            <td><?= $item->tanggal !== null ? $item->tanggal : '-'; ?></td>
                            <td><?= $item->status == 1 ? 'Hadir' : 'Alpha'; ?></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
