                        ...
                        <tr>
                            ...
                            <td class="py-2 text-left px-4 truncate max-w-[10px]"><?php echo $san->bukti_pembayaran; ?></td>
                                ...
                                <td class="py-2 text-left px-4 flex gap-2">
                                    <a href="" class="edit-class-button px-1 bg-gray-100 border-gray-400 border">
                                        Edit
                                    </a>
                ...
                <tbody>
                    <?php foreach($asatidz as $asat): ?>
                        <tr>
                            ...
                            <td class="py-2 text-left px-4 truncate max-w-[10px]"><?php echo $asat->bukti_ketersedian_mengajar; ?></td>
